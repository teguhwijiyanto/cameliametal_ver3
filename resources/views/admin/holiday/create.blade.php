                            ...
                            <form action="{{route('admin.holiday.store')}}" method="POST">
								...
								<div class="form-group">
                                        <div class="input-group date" id="name" data-target-input="nearest">
                                            ...
                                            <input name="name" type="text" class="form-control datetimepicker-input @error('name') is-invalid @enderror" data-target="#name" value="{{old('name')}}" readonly  onkeyup="this.value=''+this.value+'';"/>
